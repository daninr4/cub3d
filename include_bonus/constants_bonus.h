...
# define PLAYER_SCALE		0.10f

# define PLAYER_MOVE_SPEED	0.03f
# define PLAYER_ROT_SPEED	0.02f
# define PLAYER_FOV			60

# define GUARD_SPRITE		2
# define BARREL_SPRITE		3
# define NUMTEXTURESBARREL  3
# define MAP_DOORS "p"
# define MAP_NONSTATIC "abcdfghijklmpqrtuwxyz"

# define MAP_OBJECTS		"01pq23NSWE "
# define NOT_TRAVERSABLE	"1p"
